...
{
    public class ToleyisENController : Controller
    {
        ...
        public ActionResult SubeDetay(int? id)
        {
            ...
            if (id == null)
            {
                ...
                model.SubeTemsilcis = db.SubeTemsilci.Where(x => x.Sil != true && x.SubeId == 1).ToList();
            ...
            else
            {
                ...
                model.SubeTemsilcis = db.SubeTemsilci.Where(x => x.Sil != true && x.SubeId == id).ToList();
        ...
        public ActionResult SubeIlSec(int? id, int? durum)
        {
            ...
            else
            {
                ...
                model.SubeTemsilcis = db.SubeTemsilci.Where(x => x.Sil != true && x.SubeId == sorgu.SubeID).ToList();
